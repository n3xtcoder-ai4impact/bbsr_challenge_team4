...
import torch
import typer
from scoring_logic import cat_sim, name_sim, unit_match, year_bucket_match
...
class MaterialMapper:
    def __init__(self, specific: pd.DataFrame, generic: pd.DataFrame):
        self.specific = specific
        self.generic = generic
        self.generic_name_embeddings = embed_single(
            generic["Name (en)"].fillna("").tolist()
        )
        self.generic_cat_embeddings = embed_single(
            generic["Kategorie (en)"].fillna("").tolist()
        )
